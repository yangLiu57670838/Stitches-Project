...
app.controller('globalController', function($scope, $rootScope, $location, User) {//rootscope is used to go access rootscope variables, location is used to relocate different URLS.
	// .user {{{
