app.controller('userListController', function($scope, $routeParams, $location, User, $rootScope) {
	$scope.users = [];
...
app.controller('userAddController', function($scope, $routeParams, $location, $timeout, User) {
	...
	$scope.user = { // ?? auto? no repeat?
		_id: '_new'
	};

	//dont forget check password here
